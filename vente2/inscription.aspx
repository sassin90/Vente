    ...
    <div id="div1">
					...
					<table style="color:#fff;" border="0" cellspacing="0" cellpadding="0" width=83% >
									...
									<tr valign=middle align=left>
										...
										<td>  <asp:TextBox ID="TextBox1" class="champ" required type="text"  placeholder="Nom et prénom" runat="server"></asp:TextBox>
                                        </td>
									</tr>
									...
									<tr valign=middle align=left>
										...
										<td><asp:TextBox ID="TextBox6" class="champ"   required  placeholder="Télephone" runat="server"></asp:TextBox></td>
									</tr>
									<tr valign=middle align=left>
