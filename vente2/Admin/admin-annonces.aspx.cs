...
{
    public partial class admin_annonces : System.Web.UI.Page
    {
        Bdd db = new Bdd();
                ...
                while (db.read.Read())
                {
                    Label1.Text += "<tr><td width='100%'><div id='article'>" +
                        ...
                        "<img id='' src="+db.read[2]+" height='200' style='float:left;padding-right:20;'/>" +
                                    ...
                                    "<a class='thislink' href='bannedArticle.aspx?idA=" + db.read[0] + "'>Arrèter ce contenu</a>" +
                                    "</div></div></td></tr>";
