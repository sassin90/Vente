<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin-signales.aspx.cs" Inherits="vente2.Admin.admin_signales" %>

<html>
<head runat="server">
	<meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
	<title></title>
	<link href="admin-signales.css" rel="stylesheet" type="text/css"><link href="annonce.css" rel="stylesheet" type="text/css">
    <meta charset="utf-8">
</head>
	<body >
	<form>
	...
	<div id="div1">
					<div id=thediv>
						...
						<div class="menuadmin" >
							...
							<a class="negro">articles signalés</a>
						</div>
					</div>
