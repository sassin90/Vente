<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin-clients.aspx.cs" Inherits="vente2.Admin.admin_clients" %>

<html>
<head runat="server">
	<meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
	<title></title>
	<link href="admin-clients.css" rel="stylesheet" type="text/css"><link href="annonce.css" rel="stylesheet" type="text/css">
    <meta charset="utf-8">
</head>
	<body >
	...
	<div id="div1">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center"  height=100%>
						<tr>
							<td><br><b style="font-size:24;font-family:'1';padding:0 220 0 220; ">Tous les clients</b><br>&nbsp;</td>
						</tr>
						<!------- client 1 ... ----------->
