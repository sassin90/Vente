<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin-bloques.aspx.cs" Inherits="vente2.Admin.admin_bloques" %>

<html>
<head runat="server">
	<meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
	<title></title>
	<link href="admin-bloques.css" rel="stylesheet" type="text/css"><link href="annonce.css" rel="stylesheet" type="text/css">
    <meta charset="utf-8">
</head>
	<body >
	...
	<div id="div1">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center"  height=100%>
						<tr>
							<td><br><b style="font-size:24;font-family:'1';padding:0 220 0 220; ">Liste des clients bloqués</b><br>&nbsp;</td>
						</tr>
						<!------- client 1 ... ----------->
